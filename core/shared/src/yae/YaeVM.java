...
public class YaeVM implements ApplicationListener, InputProcessor, ResourceFinder {
    public static final String TAG = "YaeVM";
    ...
    private boolean initialize() {
        ...
        case 1:
            ...
            lua.set("yae", LuaValue.tableOf());
            lua.get("yae").set("project", convertConfig(config));
