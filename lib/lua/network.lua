...
-- @usage client = non.network.client(5000, "192.168.0.4", 54555, 54777)
...
-- @usage server = non.network.server(54555, 54777)
...
----------
-- Creates instance of byte buffer helper what can modify byte arrays used for sending data between client and server
