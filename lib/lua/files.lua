...
-- @usage externalPath = non.files.getExternalPath()
...
-- @usage localPath = non.files.getLocalPath()
...
-- @usage file = non.files.open("myfile.txt", "local")
...
-- @usage exists = non.files.exists("myfile.txt", "local")
...
-- @usage isDirectory = non.files.isDirectory("myfile.txt", "local")
...
-- @usage isFile = non.files.isFile("myfile.txt", "local")
...
-- @usage fileContents = non.files.read("myfile.txt", "local")
...
-- @usage non.files.write("myfile.txt", "I just wrote t", "local")
...
-- @tparam string type type of file path (default is "internal")
-- @treturn boolean true if file exists
-- @usage non.files.append("myfile.txt", "ext here", "local")
...
-- @usage size = non.files.size("myfile.txt", "local")
...
-- @usage lastModified = non.files.lastModified("myfile.txt", "local")
...
-- @usage success = non.files.mkdir("mydirectory", "external")
...
-- @tparam string type type of file path (default is "internal")
-- @treturn boolean true if operation was succesfull
-- @usage success = non.files.rename("myfile.txt", "thisismyfile.txt", "local")
...
-- @treturn boolean true if operation was succesfull
-- @usage success = non.files.copy("thisismyfile.txt", "myexternalfile.txt", "local", "external")
...
-- @tparam string type2 type of to file path (default is "internal")
-- @treturn boolean true if operation was succesfull
-- @usage success = non.files.move("myexternalfile.txt", "mydirectory", "external", "external")
...
-- @usage parentFile = non.files.parent("mydirectory/myexternalfile.txt", "external")
...
-- @usage childFile = non.files.child("mydirectory", "myexternalfile.txt", "external")
...
-- @usage success = non.files.remove("myfile.txt", "local")
