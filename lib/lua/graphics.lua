...
Graphics scale, rotation, color, translation and size are reset every frame before calling `non.draw`, so it is recommened to change them in `non.draw` callback.
...
@usage
-- lua -------------------------------------------------------------------------------------
image = non.graphics.image("clound.png", "external")
-- moonscript ------------------------------------------------------------------------------
image = non.graphics.image "clound.png", "external"
]]
...
@usage
-- lua -------------------------------------------------------------------------------------
font = non.graphics.font("timesnewroman.ttf", 12, "external")
-- moonscript ------------------------------------------------------------------------------
font = non.graphics.font "timesnewroman.ttf", 12, "external"
]]
...
@usage
-- lua -------------------------------------------------------------------------------------
shader = non.graphics.shader("shader.vert", "shader.frag", "external", "external")
-- moonscript ------------------------------------------------------------------------------
shader = non.graphics.shader "shader.vert", "shader.frag", "external", "external"
]]
...
@usage
-- lua -------------------------------------------------------------------------------------
worldx, worldy = non.graphics.project(100, 100)
-- moonscript ------------------------------------------------------------------------------
worldx, worldy = non.graphics.project 100, 100
]]
...
@usage
-- lua -------------------------------------------------------------------------------------
screenx, screeny = non.graphics.project(400, 100)
-- moonscript ------------------------------------------------------------------------------
screenx, screeny = non.graphics.project 400, 100
]]
...
@usage
-- lua -------------------------------------------------------------------------------------
width = non.graphics.getWidth()
-- moonscript ------------------------------------------------------------------------------
width = non.graphics.getWidth!
]]
function non.graphics.getWidth()
  return non.graphics.module:getWidth()
end
...
@usage
-- lua -------------------------------------------------------------------------------------
height = non.graphics.getHeight()
-- moonscript ------------------------------------------------------------------------------
height = non.graphics.getHeight!
]]
function non.graphics.getHeight()
  return non.graphics.module:getHeight()
end
...
@tparam number width new width of the screen
@tparam number height new height of the screen
@usage
-- lua -------------------------------------------------------------------------------------
non.graphics.setSize(640, 480)
-- moonscript ------------------------------------------------------------------------------
non.graphics.setSize 640, 480
]]
function non.graphics.setSize(width, height)
  non.graphics.module:setSize(width, height)
end
...
@usage
-- lua -------------------------------------------------------------------------------------
non.graphics.setBlending("additive")
-- moonscript ------------------------------------------------------------------------------
non.graphics.setBlending "additive"
]]
...
@usage
-- lua -------------------------------------------------------------------------------------
blendMode = non.graphics.getBlending()
-- moonscript ------------------------------------------------------------------------------
blendMode = non.graphics.getBlending!
]]
...
@usage
-- lua -------------------------------------------------------------------------------------
non.graphics.setBackgroundColor(100, 100, 255, 255)
-- moonscript ------------------------------------------------------------------------------
non.graphics.setBackgroundColor 100, 100, 255, 255
]]
...
@usage
-- lua -------------------------------------------------------------------------------------
non.graphics.setColor(100, 100, 255, 255)
-- moonscript ------------------------------------------------------------------------------
non.graphics.setColor 100, 100, 255, 255
]]
...
@usage
-- lua -------------------------------------------------------------------------------------
width, height = non.graphics.getImageBounds(image)
-- moonscript ------------------------------------------------------------------------------
width, height = non.graphics.getImageBounds image
]]
...
@usage
-- lua -------------------------------------------------------------------------------------
non.graphics.rectangle(0, 0, 30, 30, "fill")
-- moonscript ------------------------------------------------------------------------------
non.graphics.rectangle 0, 0, 30, 30, "fill"
]]
...
@usage
-- lua -------------------------------------------------------------------------------------
non.graphics.circle(0, 0, 30, "fill")
-- moonscript ------------------------------------------------------------------------------
non.graphics.circle 0, 0, 30, "fill" 
]]
...
@usage
-- lua -------------------------------------------------------------------------------------
non.graphics.ellipse(0, 0, 30, 30, "fill")
-- moonscript ------------------------------------------------------------------------------
non.graphics.ellipse 0, 0, 30, 30, "fill"
]]
...
@usage
-- lua -------------------------------------------------------------------------------------
non.graphics.polygon({0, 0, 30, 30, 50, 80, 120, 190}, "fill")  
-- moonscript ------------------------------------------------------------------------------
non.graphics.polygon {0, 0, 30, 30, 50, 80, 120, 190}, "fill" 
]]
