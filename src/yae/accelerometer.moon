...
-- @treturn number z value of accelerometer
-- @usage
-- x, y, z = yae.accelerometer.getRotation!
getRotation = ->
  getX!, getY!, getZ!
...
-- @usage
-- available = yae.accelerometer.isAvailable!
isAvailable = ->
