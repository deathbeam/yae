...
public class Non implements ApplicationListener {
    ...
    public static FileHandle file(String path) throws IOException { return Gdx.files.internal(path); }
    ...
    public void resize (int width, int height) { script.invoke("non", "resize"); }
    public void pause ()                       { script.invoke("non", "pause"); }
    public void resume ()                      { script.invoke("non", "resume"); }
    public void dispose ()                     { script.invoke("non", "close"); }
}